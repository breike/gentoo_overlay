...
DESCRIPTION="🍓 A healthy, byte-sized window manager"
...
# Portage.
SRC_URI="https://github.com/JLErvin/berry/archive/refs/tags/${PV}.tar.gz"
...
DEPEND="${RDEPEND} x11-libs/libX11 x11-libs/libXft x11-libs/libXinerama"
